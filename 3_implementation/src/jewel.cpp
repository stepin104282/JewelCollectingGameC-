...
void Jewel::changeUserLocationOnButtonClick(int *x,int *y,char keyPressed,int *noOfMoves,int *gameQuit)
{
	switch(keyPressed){
...
void Jewel::drawBoundary(int x,int y,int *posX,int *posY,int *gameOver){ // Passing User Coordinate And JWEL Coordinate
